...
class fLDM:
    ...
    def __init__(self, metafile, num_voxels, device=torch.device('cpu'),
        ...
        to_save = {
        'model': model.cond_stage_model.state_dict(),
        'metafile': metafile,
        ...
        torch.save(to_save, path_fmri_encoder_from_final_mindvis)
        print(f"Model Saved at {path_fmri_encoder_from_final_mindvis}")
